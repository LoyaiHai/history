package com.lhs.toollibrary.button;
...
import com.lhs.toollibrary.R;

/**
 * 异步请求按钮
 * **/
public class AsynReButton extends View {
    ...
    public AsynReButton(Context context) {
        super(context, null);
    }

    public AsynReButton(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs, 0);
    }

    public AsynReButton(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
